...
- **한국남부발전 인턴 재직중(디지털인프라실 AI혁신부)**
  - 발전소 자료 취합을 위해 폐쇄망 환경에서 Python으로 PDF 자동 변환 도구를 개발하며 한글과컴퓨터에서 제공하는 보안 모듈을 내부망으로 반입하기 위해 정보보안실의 타당성 검토를 진행했습니다.
...
- **2025 지역문제 해결 연합 해커톤 [Emergency_911](https://github.com/Diving-Seagull/Emergency_911)**
  - 2020년 태풍 마이삭 당시 1시간 만에 부산 소방본부에 3400건의 신고가 몰려 ARS로 전환되었고 일평균 신고의 37%가 중복 사건으로 기록될 만큼 소방 인력 부족이 심각했습니다. 이에 **소방 업무 효율화를 위한 인공지능 기반 신고 처리 시스템 Emergency_911**을 개발했습니다.
...
- **디지랩 챌린지: 기술로 바꾸는 세상 - 제주와 함께하는 힐링산책 [간당](https://github.com/Diving-Seagull/gandang)**
  - 2024 [디지랩 챌린지](https://digilab-hackathon.com/)에 참가하여 사용자가 아름다운 제주의 해안도로를 따라 주행할 수 있도록 **서귀포시 해안도로 내비게이션 간당**을 개발했습니다.
...
- **카카오테크캠퍼스 - 전세사기 대처 웹 플랫폼 [Boomerang](https://github.com/kakao-tech-campus-2nd-step3/Team11_BE)**
    - 전세사기 피해 후 복잡한 절차와 방대한 서류 제출로 어려움을 겪는 문제를 해결하기 위해 아이디어톤에서 As-Is -> To-Be 분석, 마켓 리서치, Crazy 8 기법, 페르소나 및 저니 맵 작성 등 다양한 기획 기법을 활용해 사용자 관점에서 문제를 정의하여 **전세사기 대처 웹 플랫폼 Boomerang**을 기획했습니다.
    - Step 3에서는 실제 개발을 진행하며, 복잡한 서류 제출 과정과 오픈 채팅의 낮은 신뢰도 문제를 해결하기 위해 PDFBox AcroForm을 활용한 서류 자동 완성 기능과 Redis, SMTP를 활용한 멘토 인증을 위한 이메일 인증 기능을 담당하여 개발했습니다.
...
- **부산 글로벌 데이터 해커톤 DIVE2024 - WYD2027 팀 관리 애플리케이션 [With-u](https://github.com/Diving-Seagull/With-u)**
  - 부산 글로벌 데이터 해커톤 [DIVE2024](https://www.dxchallenge.co.kr/about-1)에서 삼정KPMG의 발제를 받아 **WYD2027 행사를 위한 팀 관리 애플리케이션 With-u**를 개발했습니다.
  - 백엔드 개발을 담당하여 FCM을 활용한 공지사항 푸시 알림, 부산시 공공데이터를 활용한 관광지도 서비스, Google Cloud Translation API를 통한 다국어 번역 서비스 등을 담당하여 개발했습니다.
